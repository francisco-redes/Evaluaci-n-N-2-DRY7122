...
def calcular_consumo_combustible(d, e):
    consumo = d / e
    return consumo
...
while True:
    ...
    e = float(input("Por favor ingrese la eficiencia de combustible de su vehículo (km/l): "))
    ...
    consumo_combustible = calcular_consumo_combustible(d, e)
    print("////////////////////////////////////////////////////////////////////////////////////////")

    print("\nInformación de su viaje:")
    print("Origen:", inicio)
    print("Destino:", destino)
    print("Kilómetros recorridos:", "{:.2f}".format(d), "km")
    print("Duración del viaje:", tiempo)
    print("Tipo de vehículo:", tipo_vehiculo)
    print("Eficiencia de combustible:", e, "km/l")
